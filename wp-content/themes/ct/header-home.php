...
<html <?php language_attributes(); ?>>
  ...
  <body class="home">
      ...
      <div id="slider">
        <div class="wrapper">
            <div class="nivoSlider" style="height:360px;">
                <img src="<?php echo (get_bloginfo( 'template_url' )); ?>/img/slide1.jpg" alt=""/>
                <img src="<?php echo (get_bloginfo( 'template_url' )); ?>/img/slide2.jpg" alt=""/>
                <img src="<?php echo (get_bloginfo( 'template_url' )); ?>/img/slide4.jpg" alt=""/>
                <img src="<?php echo (get_bloginfo( 'template_url' )); ?>/img/slide3.jpg" alt="" title="example"/>
            </div>
        </div>
      </div>
      <div id="main">
